...
public interface IShopSaleService
{
    ...
    public Task CreateShopCheck(Guid shopId, CancellationToken cancellationToken);
    public Task UpdateShopCheck(Guid shopId, Guid checkId, decimal totalPrice, CancellationToken cancellationToken);
