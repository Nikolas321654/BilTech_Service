    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WarehouseChecks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WarehouseChecks_Warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CheckItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CheckItems_WarehouseChecks_OrderId",
                        column: x => x.OrderId,
                        principalTable: "WarehouseChecks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_CheckItems_OrderId",
                table: "CheckItems",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_CheckItems_ProductId",
                table: "CheckItems",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseChecks_WarehouseId",
                table: "WarehouseChecks",
                column: "WarehouseId");
